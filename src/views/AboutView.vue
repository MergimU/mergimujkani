          ...
          <div class="about__description__boxes-container">
            <svg xmlns="http://www.w3.org/2000/svg"
              ...
              <defs>
                ...
                <filter id="variant-1_svg__filter0_d"
                        width="140"
                        height="140"
                        x="84"
                        y="-12"
            ...
            <!-- <div class="about__description__boxes-container__animate-box"></div> -->
          </div>
          <p>
            ...
            CV: <a href="https://drive.google.com/file/d/14ZGo4prvvUAf2Q3OGLY6kSDsLM28ovxh/view?usp=sharing"
            ...
            frameworks such as
            React and
            Vue. Passionate about creating reliable and visually appealing
            web applications. <br>
            ...
            Skills:
            <br />
            - Proficient in JavaScript, React, TypeScript, HTML, and CSS<br />
            - Experience with modern web development tools such as Vite and Webpack.<br />
            ...
            discussing technical concepts with stakeholders.<br />
            - Continuous Learning: Willingness to stay updated with the latest technologies, frameworks, and industry
            trends through self-learning, training, and professional development opportunities.<br />
          </p>
        </div>
      </div>
    </div>
