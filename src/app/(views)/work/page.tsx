...
export const metadata: Metadata = {
  ...
  description:
    'Experienced Front-End Engineer with over 6 years of experience working with web frameworks such as React and Vue. Passionate about creating reliable and visually appealing web applications.  Skilled in modern web development techniques, including responsive design, accessibility, and performance optimization. Seeking a challenging role at a company that values creativity and innovation.',
  keywords:
    'Front-End Engineer, React, React Native, NextJS, Styled Components, CSS, SCSS, VueJS, UI, Front End, Web Developer, Front End Web Developer, Website, Web-app, SVG, Animations, Responsive, Web Design, Codepen, Netlify',
};
      ...
      <div className='work__container'>
        ...
        <div className='work__worked-for no-bg'>
          <div className='work__worked-for__info'>
            <h4>Freelance — Front-End Engineer</h4>
        ...
        <div className='work__worked-for'>
          <div className='work__worked-for__info'>
            <h4>Solidfi</h4>
            <p>Front-End Engineer / Fintech / (Feb 2019 - Jan 2023)</p>
            <p>
              <span>- Implemented responsive and dynamic user interfaces using React and Vue</span>
              <span>
                - Developed and maintained modular, reusable components to ensure code efficiency and consistency
              </span>
        ...
        <div className='work__worked-for'>
          <div className='work__worked-for__info'>
            <h4>UNE</h4>
            <p>Front-End Engineer / Web Agency / (Nov 2017 - Mar 2019)</p>
            <p>
        ...
        <div className='work__worked-for work__worked-for--space'>
          <div className='work__worked-for__info'>
            ...
            <p>
              ...
              <span>
                - Actively participated in team meetings, code reviews, and discussions to enhance overall project
                quality.
              </span>
              <span>- Ensured cross-browser compatibility and optimized the performance of web applications.</span>
            </p>
        ...
        <div className='work__worked-for'>
          <div
            ...
            <div>
              ...
              <p>
                Tired of searching for the best deals or struggling with unfamiliar words while browsing?
                <br />
                <br />
              ...
              <ol>
                <li>
                  <p>
                    Effortless Price Comparison: Just highlight an item you'd like to buy, and the extension displays
                    purchase options from various retailers, helping you find the best deal.
                  </p>
                </li>
                <li>
                  <p>
                    Instant Word Definitions: Encountered an unfamiliar word? Simply highlight it, and the extension
                    displays definitions and information from trusted sources like Wikipedia, saving you time and
